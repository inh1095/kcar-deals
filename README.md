...
**추천 5대 규칙**(`build_guide.pick_top5`, 상수 `PICK_KM`·`PICK_GRADES`·`PICK_N_FULL`·`PICK_N_HYB`):
풀옵션(장비 20+ · 안전 4종) 중 7만km 이하 · 등급 안심/괜찮음 · 건식 DCT 제외 · 차종별 1대 ·
10년 총지출 낮은 순 4대 + 하이브리드 중 같은 조건에서 만족 요소가 가장 많은 1대.
